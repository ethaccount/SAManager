...
export interface MethodToResponse {
	...
	// erc-5792
	[Methods.wallet_getCapabilities]: unknown
	[Methods.wallet_sendCalls]: unknown
	[Methods.wallet_getCallsStatus]: unknown
	[Methods.wallet_showCallsStatus]: unknown
}
...
export interface SafeAppsTransaction {
	to: string
	value: string
	data: string
}

export type BlockNumber = 'latest' | 'earliest' | 'pending' | string // hex number

export type EthGetBlockByNumberPayload = {
	call: 'eth_getBlockByNumber'
	params: [BlockNumber, boolean]
}
