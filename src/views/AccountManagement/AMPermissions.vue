...
// Load sessions when component mounts or account changes
				...
				>
					...
					<div class="flex items-center gap-2">
						<div
							...
							:class="session.isEnabled ? 'bg-green-500/10 text-green-500' : 'bg-red-500/10 text-red-500'"
						>
							...
							<div class="space-y-2">
								...
								>
									<div class="flex items-center justify-between mb-2">
										<div class="flex items-center gap-2">
											<span class="text-sm font-mono">{{ shortenAddress(action.actionId) }}</span>
